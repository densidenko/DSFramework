...
namespace DSFramework.Data.Contracts.Models
{
    ...
    public class EntityHolder<TIdentity, TData> : IEntityHolder<TIdentity>, IEquatable<EntityHolder<TIdentity, TData>>
    {
        ...
        public bool Equals(EntityHolder<TIdentity, TData> other)
        {
            ...
            return EqualityComparer<TIdentity>.Default.Equals(Id, other.Id) && DataVersion == other.DataVersion &&
                   CreatedDate.Equals(other.CreatedDate) && ModifiedDate.Equals(other.ModifiedDate) && string.Equals(CreatedBy, other.CreatedBy) &&
                   string.Equals(ModifiedBy, other.ModifiedBy) && string.Equals(Application, other.Application) &&
        ...
        public static bool operator ==(EntityHolder<TIdentity, TData> left, EntityHolder<TIdentity, TData> right) => Equals(left, right);
