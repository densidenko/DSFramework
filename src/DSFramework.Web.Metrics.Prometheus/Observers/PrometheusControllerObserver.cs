...
namespace DSFramework.Web.Metrics.Prometheus.Observers
{
    ...
    {
        private readonly Counter _total = global::Prometheus.Client.Metrics.CreateCounter("controller_calls_total",
        ...
        private readonly Histogram _duration = global::Prometheus.Client.Metrics.CreateHistogram("controller_calls_duration_seconds",
        ...
        public void ReportEndpointUsage(string controller,
                                        string methodName,
                                        string application,
                                        string clientEnv)
            => _total.Labels(_controllerVersion,
                             _obsolete,
                             controller,
                             methodName,
                             _entityType,
        ...
        public void Observe(string controller,
                            string methodName,
                            string application,
                            string clientEnv,
                            TimeSpan duration)
            => _duration.Labels(_controllerVersion,
                                _obsolete,
                                controller,
                                methodName,
                                _entityType,
