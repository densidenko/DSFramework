...
namespace DSFramework.Web.AspNetCore.Http
{
    ...
    public static class HttpRequestExtensions
    {
        ...
        /// </summary>
        public static string GetReferrerUrl(this HttpContext httpContext) => httpContext.GetHeaderValue("Referer");
        ...
        public static string GetUser(this HttpContext httpContext)
            => httpContext.User.Identity.IsAuthenticated ? httpContext.User.Identity.Name : string.Empty;
        ...
        /// </summary>
        public static Uri GetBaseUri(this HttpContext httpContext) => new Uri(httpContext.GetBaseUrl());
        ...
        ///     Gets the current HttpContext.Request's address.
        /// </summary>
        public static Uri GetRawUri(this HttpContext httpContext) => new Uri(GetRawUrl(httpContext));
