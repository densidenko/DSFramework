...
namespace DSFramework.Web.AspNetCore.Extensions
{
    public static class IdentityExtensions
    {
        ...
        public static string FindUserClaimValue(this IIdentity identity, string claimType)
            => (identity as ClaimsIdentity)?.FindFirstValue(claimType);
        ...
        public static string FindUserName(this IIdentity identity) => identity?.FindUserClaimValue(UserClaimTypes.USER_NAME);
    }
}