...
namespace DSFramework.Helpers
{
    /// <summary>
    ///     Get the string name and type of a property or field. Eg
    ///     <c>string name = Property.Name&lt;string&gt;(x =&gt; x.Length);</c>
    /// </summary>
    public static class PropertyHelper
    {
        /// <summary>
        ///     Gets the type for the specified entity property or field. Eg
        ///     <c>string name = Property.Name&lt;string&gt;(x =&gt; x.Length);</c>
        /// </summary>
