...
namespace DSFramework.Data.MongoDB.Utils
{
    /// <summary>
    ...
    public static class IdGenerator
    {
        ...
        public static TKey GetId<TKey>()
        {
            ...
            switch (idTypeName)
            {
                ...
                case "Int16":
                    return (TKey)(object)_random.Next(1, short.MaxValue);
                case "Int32":
                    return (TKey)(object)_random.Next(1, int.MaxValue);
                case "Int64":
                    return (TKey)(object)_random.NextLong(1, long.MaxValue);
                case "String":
