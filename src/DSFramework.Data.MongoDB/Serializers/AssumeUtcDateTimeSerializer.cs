...
namespace DSFramework.Data.MongoDB.Serializers
{
    public class AssumeUtcDateTimeSerializer : DateTimeSerializer
    {
        ...
        public AssumeUtcDateTimeSerializer()
            : base(DateTimeKind.Utc, BsonType.Document)
        {
            _helper = new SerializerHelper(new SerializerHelper.Member("DateTime", DATE_TIME_FLAG),
