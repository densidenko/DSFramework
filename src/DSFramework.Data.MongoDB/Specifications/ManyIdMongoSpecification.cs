...
namespace DSFramework.Data.MongoDB.Specifications
{
    ...
    {
        public ManyIdMongoSpecification(params string[] ids)
            : base(ids)
        { }
    }
    ...
    public class ManyIdMongoSpecification<TKey, TObject> : MongoSpecification<TObject> where TObject : IHasId<TKey>
    {
        ...
        public override FilterDefinition<TObject> BuildFilter(FilterDefinitionBuilder<TObject> filterBuilder) => filterBuilder.In(a => a.Id, _ids);
    }
}