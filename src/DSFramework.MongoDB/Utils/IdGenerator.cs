...
namespace DSFramework.MongoDB.Utils
{
    /// <summary>
    ...
    public static class IdGenerator
    {
        ...
        public static TKey GetId<TKey>()
        {
            ...
            switch (idTypeName)
            {
                case "Guid":     return (TKey)(object)Guid.NewGuid();
                case "Int16":    return (TKey)(object)Random.Next(1, short.MaxValue);
                case "Int32":    return (TKey)(object)Random.Next(1, int.MaxValue);
                case "Int64":    return (TKey)(object)Random.NextLong(1, long.MaxValue);
                case "String":   return (TKey)(object)Guid.NewGuid().ToString("N");
                case "ObjectId": return (TKey)(object)ObjectId.GenerateNewId();
            }
