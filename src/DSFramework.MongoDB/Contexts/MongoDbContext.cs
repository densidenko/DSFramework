...
using DSFramework.MongoDB.Attributes;
using MongoDB.Bson;
...
namespace DSFramework.MongoDB.Contexts
{
    ...
    public class MongoDbContext : IMongoDbContext
    {
        ...
        {
            return (typeof(TDocument).GetTypeInfo().GetCustomAttributes(typeof(CollectionNameAttribute)).FirstOrDefault() as CollectionNameAttribute)
                ?.Name;
        }
