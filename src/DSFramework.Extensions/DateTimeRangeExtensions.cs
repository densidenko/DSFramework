...
namespace DSFramework.Extensions
{
    ...
    public static class DateTimeRangeExtensions
    {
        ...
        public static IEnumerable<DateTime> DaysInRange(this IDateTimeRange dateRange)
            => Enumerable.Range(0, dateRange.TimeSpan.Days)
                         .Select(offset => new DateTime(dateRange.StartTime.AddDays(offset).Year,
        ...
        /// <returns></returns>
        public static IEnumerable<DateTime> DaysInRange(DateTime start, DateTime end) => new DateTimeRange(start, end).DaysInRange();
    }
}