...
namespace DSFramework.Extensions
{
    ...
    public static class DateTimeExtensions
    {
        ...
        public static IEnumerable<DateTime> DaysOfMonth(int year, int month)
            => Enumerable.Range(0, DateTime.DaysInMonth(year, month)).Select(day => new DateTime(year, month, day + 1));
        ...
        /// <returns></returns>
        public static int TotalDaysInMonth(this DateTime dateTime) => DaysOfMonth(dateTime.Year, dateTime.Month).Count();
